---
title: PyCharm的安装以及永久激活
date: 2022-05-30 16:27:18
tags: Python学习日记
categories: 工具
---

需要下载的有 [fineagent.jar](../../../fineagent.jar) 

以及pycharm正版应用 [PyCharm-for-intel_2021.3_(最低10.8)__macwk.com.dmg](../../../Downloads/PyCharm-for-intel_2021.3_(最低10.8)__macwk.com.dmg) 

 [fineagent.jar](../../../fineagent.jar) 将该文件复制到 `/Users/你的用户名/` 文件夹下

打开访达，点击左侧的 `应用程序` 找到 `PyCharm`，在 WebStorm 图标上右键，点击 `显示包内容`

进入 `Contents` 目录，再进入 `bin` 目录，使用文本编辑器打开 `PyCharm.vmoptions` 文件

在最后面添加 `-javaagent:/Users/你的用户名/fineagent.jar`，记得修改一下你的用户名。

运行 WebStorm, 选择 `Activate PyCharm`，再点击 `Activation Code`
